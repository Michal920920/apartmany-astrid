...
// import img1 from '../../assets/img/blog-details/icon.png';
// import img2 from '../../assets/img/blog-details/icon.png';
// import img3 from '../../assets/img/blog-details/icon.png';
import {Component} from "react";
//
// const blogpost = [
// 	{
// 		img: img1,
// 		title: 'Each of our 4 double rooms has its own distinct.',
// 		postdate: '28th Aug 2020',
// 		author: 'Admin',
// 		text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.'
// 	},
// 	{
// 		img: img2,
// 		title: 'Each of our 6 double rooms has its own distinct.',
// 		postdate: '28th Aug 2020',
// 		author: 'Admin',
// 		text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.'
// 	},
...
// 	{
// 		img: img1,
// 		title: 'Each of our 2 double rooms has its own distinct.',
// 		postdate: '28th Aug 2020',
// 		author: 'Admin',
// 		text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.'
// 	},
// 	{
// 		img: img2,
// 		title: 'Each of our 3 double rooms has its own distinct.',
// 		postdate: '28th Aug 2020',
// 		author: 'Admin',
// 		text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.'
// 	},
// 	{
// 		img: img3,
// 		title: 'Each of our 5 double rooms has its own distinct.',
// 		postdate: '28th Aug 2020',
// 		author: 'Admin',
// 		text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.'
// 	},
